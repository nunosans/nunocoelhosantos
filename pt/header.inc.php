...
<head>
	...
	<title>Nuno Coelho Santos<? if ($page=='Home' || $page=='Perfil') {echo(' &nbsp;—&nbsp; '); echo $title;} else {echo(' &nbsp;~&nbsp; '); echo $title;} ?></title>
...
<body>
	...
	<div id="header">
		...
		<ul id="nav">
			<li><a href="<? if ($page=='Home') {echo('#portfolio');} else {echo('/pt/');}?>">Portfólio</a></li>
			<li><a href="/pt/perfil">Perfil</a></li>
		</ul>
	</div>
